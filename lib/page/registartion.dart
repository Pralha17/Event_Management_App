...
class _RegistrationScreenState extends State<RegistrationScreen> {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => RazorPayPage(
                      ...
                      amount: widget.eventFee
                          .toInt(), // Convert fee to integer for RazorPay
                    ),
                  ),
                );
              },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Register for ${widget.eventName}',
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                      fontSize: 16,
                      color: Colors.grey[700]), // Subtle color for details
                ),
                const SizedBox(height: 16),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        const Text('• ',
                            style: TextStyle(
                                color: Colors.blue)), // Color for bullet
                        Expanded(
                            child: Text(rule,
                                style: TextStyle(
                                    color: Colors
                                        .grey[700]))), // Color for rule text
                      ],
                    ),
                  ),
                const SizedBox(height: 16),
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (newValue) {
                    setState(() {
                      _selectedSubEvent =
                          newValue; // Update the selected sub-event
                    });
                  },
                  validator: (value) {
                ...
                const Text(
                  ...
                  style: TextStyle(
                      ...
                      fontWeight:
                          FontWeight.bold), // Custom color for instructions
                ),
                const SizedBox(height: 16),
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                      ...
                      borderSide: const BorderSide(
                          color: Colors.blue), // Color for border
                    ),
                ...
                TextFormField(
                  ...
                  readOnly:
                      true, // Make the email field read-only since it comes from Firebase
                ),
                const SizedBox(height: 16),
